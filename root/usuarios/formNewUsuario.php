  ...
  <div class="section">
	...
	mysql_select_db('admin_csc');
	     ...
	     if (isset($_POST['A'])) {
                            ...
                            $roles = mysql_real_escape_string($_POST["roles"], $conn);
                                                        
                             agregarUser($nombre,$user,$pass1,$pass2,$roles);
...
<div class="row">
<div class="col-md-12">
<hr> <a href="usuarios.php"><input type="button" value="Volver" class="btn btn-primary"></a>
</div>
</div>
</div>
