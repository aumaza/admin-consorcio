...
<div class="panel panel-info" >
 ...
 <div class="input-group">
  ...
  <select class="browser-default custom-select" name="roles">
  <option value="" disabled selected>Roles</option>
  <option value="1" <?php if($fila['roles'] == "1") echo 'selected'; ?>>Administrador</option>
  <option value="0" <?php if($fila['roles'] == "0") echo 'selected'; ?>>Inquilino/Propietario</option>
  </select>
</div>
  <br>
 ...
 <div class="form-group">
   ...
   <button type="submit" class="btn btn-success" name="B"><span class="glyphicon glyphicon-pencil"></span>  Cambiar Roles</button>
   <a href="usuarios.php"><input type="button" value="Volver" class="btn btn-primary"></a>
