...
<div class="navbar-header">
  ...
  <a class="navbar-brand"><span class="pull-center "><img src="../../icons/actions/view-expenses-categories.png"  class="img-reponsive img-rounded"><strong> Total Cobros </strong></a>
</div>
...
<!-- Links -->
    <ul class="nav navbar-nav navbar-right">
      <li class="active" ><a href="calcular_cobros.php">Calcular Cobros Totales <span class="pull-center "><img src="../../icons/actions/view-bank-account-checking.png"  class="img-reponsive img-rounded"></a></li>
    </ul>
<!-- Search -->
</div>
</div>
