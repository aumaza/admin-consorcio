...
<div class="container-fluid">
    ...
    if($conn){
		...
		$sqlInsert = "UPDATE habitantes SET nombreApellido='$nombre', sexo='$sexo', situacion='$situacion', uni_func='$uni_func', departamento='$dpto', email='$email', telefono='$telefono', movil='$movil' WHERE id = '$id'";
