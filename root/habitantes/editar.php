...
<html><head>
	<meta charset="utf-8">
	<title>Habitantes - Editar Registro</title>
...
<div class="input-group">
  ...
  <option value="Propietario" <?php if($fila['situacion'] == "Propietario") echo 'selected'; ?>>Propietario</option>
  <option value="Inquilino" <?php if($fila['situacion'] == "Inquilino") echo 'selected'; ?>>Inquilino</option>
  </select>
</div>
  
  <div class="input-group">
    <span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
    <input id="text" type="text" class="form-control" name="uni_func" placeholder="Unidad Funcional" value="<?php echo $fila['uni_func']; ?>">
  </div>
  <div class="input-group">
    <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
    <input id="text" type="text" class="form-control" name="dpto" placeholder="Departamento" value="<?php echo $fila['departamento']; ?>">
  </div>
  <div class="input-group">
  ...
  <div class="input-group">
    ...
    <input  type="text" class="form-control" name="movil" placeholder="1544444444" value="<?php echo $fila['movil']; ?>">
  </div>
  <br>
