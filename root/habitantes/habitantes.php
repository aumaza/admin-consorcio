...
<div class="navbar-header">
  ...
  <a class="navbar-brand"><span class="pull-center "><img src="../../icons/actions/meeting-attending.png"  class="img-reponsive img-rounded"><strong> Habitantes </strong></a>
</div>
...
<!-- Links -->
    <ul class="nav navbar-nav navbar-right">
      <li class="active" ><a href="nuevoRegistro.php">Ingresar Habitante <span class="pull-center "><img src="../../icons/actions/list-add.png"  class="img-reponsive img-rounded"></a></li>
    </ul>
<!-- Search -->
</div>
</div>
...
if($conn)
{
	...
	$i=0;
            echo "<table class='display compact' id='myTable'>";
              echo "<thead>
                    ...
                    <th class='text-nowrap text-center'>Situación</th>
	...
	while($fila = mysql_fetch_array($resultado))
	{
			 ...
			 echo "<td align=center>".$fila['situacion']."</td>";
