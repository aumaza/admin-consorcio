...
<html><head>
	<meta charset="utf-8">
	<title>Cobros - Editar Registro</title>
...
<div class="panel panel-info" >
  <div class="panel-heading">
    <h2 class="panel-title text-center text-default "><span class="pull-center "><img src="../../icons/actions/view-loan.png"  class="img-reponsive img-rounded"> Cobros - Editar Registro</h2>
  </div>
  ...
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
             ...
             <?php
              ...
              if($res)
              {
                  ...
                  while ($valores = mysql_fetch_array($res))
                    {
                        echo '<option value="'.$valores[nombreApellido].'" '.(($fila['nombreApellido']== $valores[nombreApellido])?'selected="selected"':"").'>'.$valores[nombreApellido].'</option>';
   ...
   <div class="input-group">
    ...
    <input id="text" type="text" class="form-control" name="uni_func" value="<?php echo $fila['uni_func']; ?>">
  </div>
  
  <div class="input-group">
    <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
    <input id="text" type="text" class="form-control" name="dpto" value="<?php echo $fila['departamento']; ?>">
  </div>
  
  <div class="input-group">
    <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
    <input  type="text" class="form-control" name="monto" value="<?php echo $fila['monto']; ?>">
  </div>
  ...
  <option value="Pago" <?php if($fila['estado'] == "Pago") echo 'selected'; ?>>Pago</option>
  <option value="Debe" <?php if($fila['estado'] == "Debe") echo 'selected'; ?>>Debe</option>
  </select>
</div>
