...
<div class="container-fluid">
    ...
    if($conn){
		...
		$sqlInsert = "UPDATE cobros SET nombreApellido='$nombre', uni_func='$uni_func', departamento='$dpto', monto='$monto', estado='$estado', fecha='$fecha' WHERE id = '$id'";
