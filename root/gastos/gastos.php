...
<div class="navbar-header">
  ...
  <a class="navbar-brand"><span class="pull-center "><img src="../../icons/actions/view-financial-payment-mode.png"  class="img-reponsive img-rounded"><strong> Gastos </strong></a>
</div>
...
<!-- Links -->
    <ul class="nav navbar-nav navbar-right">
      <li class="active" ><a href="nuevoRegistro.php">Ingresar Gasto <span class="pull-center "><img src="../../icons/actions/list-add.png"  class="img-reponsive img-rounded"></a></li>
    </ul>
<!-- Search -->
</div>
</div>
...
if($conn)
{
	...
	$i=0;
            echo "<table class='display compact' id='myTable'>";
              echo "<thead>
                    ...
                    <th class='text-nowrap text-center'>Comprobante</th>
                    <th>&nbsp;</th>
                    </thead>";
	...
	while($fila = mysql_fetch_array($resultado))
	{
			 ...
			 echo "<td align=center>".$fila['comprobante']."</td>";
			 ...
			 echo '<a href="upload.php?id='.$fila['id'].'" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-cloud-upload"></span> Cargar Comprobante</a>';
			 echo '<a href="open.php?comprobante='.$fila['comprobante'].'" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-cloud-download"></span> Ver Comprobante</a>';
			 echo "</td>";
			 echo "</tr>";
				$i++;
		 		$count++;
