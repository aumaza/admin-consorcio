...
<html><head>
	<meta charset="utf-8">
	<title>Gastos - Editar Registro</title>
...
<div class="panel panel-info" >
  <div class="panel-heading">
    ...
    <select class="mdb-select md-form" name="tipo_gasto">
      ...
      <option value="Ordinario" <?php if($fila['tipo_gasto']=='Ordinario') echo 'selected'; ?>>Ordinario</option>
      <option value="Extraordinario" <?php if($fila['tipo_gasto']=='Extraordinario') echo 'selected'; ?>>Extraordinario</option>
    </select>
   </div>
   </div>
   </div><br>
  ...
  <div class="input-group">
    ...
    <input id="text" type="text" class="form-control" name="descripcion" placeholder="Descripción" value="<?php echo $fila['descripcion']; ?>">
  </div>
  <div class="input-group">
    <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
    <input id="text" type="text" class="form-control" name="monto" placeholder="Monto" value="<?php echo $fila['monto']; ?>">
  </div>
  <div class="input-group">
